  ...
  plugins = {
    ...
    lsp.servers.nixd = {
      ...
      settings = {
        ...
        options = {
          nixos.expr = ''(builtins.getFlake "${flake}").nixosConfigurations.nixos-desktop.options'';
          home_manager.expr = ''(builtins.getFlake "${flake}").nixosConfigurations.nixos-desktop.options'';
        };
